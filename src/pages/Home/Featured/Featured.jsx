    ...
    return (
        ...
        >
            <div className='bg-black bg-opacity-60 pt-8'>
                ...
                ></SectionTitle>
                <div className='md:flex items-center justify-center pb-20 px-4 pt-12 md:px-36'>
                    <div>
                    ...
                    <div className='md:ml-10'>
                        ...
                        <button className="btn btn-neutral btn-outline text-white border-0 border-b-4 mt-4 rounded-xl uppercase">Read More</button>
                    </div>
                </div>
            </div>
        </div>
