                ...
                >
                    ...
                    <SwiperSlide>
                        <div className='relative h-[300px] sm:h-[350px] md:h-[420px] w-full'>
                            ...
                            <h3 className='absolute bottom-5 left-1/2 transform -translate-x-1/2 sm:text-2xl md:text-3xl lg:text-4xl text-center uppercase text-white px-10 py-2'>Drinks</h3>
                        </div>
                    </SwiperSlide>
                </Swiper>
            </section>
